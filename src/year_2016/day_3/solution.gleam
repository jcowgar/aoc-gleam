...
pub fn main() {
  ...
  aoc.sample(2016, 3, 1, 1) |> aoc.expect(0) |> aoc.run(part1)
  aoc.problem(2016, 3, 1) |> aoc.expect(869) |> aoc.run(part1)

  aoc.sample(2016, 3, 2, 2) |> aoc.expect(6) |> aoc.run(part2)
  aoc.problem(2016, 3, 2) |> aoc.expect(1544) |> aoc.run(part2)
}
