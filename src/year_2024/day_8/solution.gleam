...
pub fn main() {
  ...
  aoc.problem(aoc.Actual, 2024, 8, 1) |> aoc.expect(364) |> aoc.run(part1)

  aoc.problem(aoc.Test, 2024, 8, 1) |> aoc.expect(34) |> aoc.run(part2)
  aoc.problem(aoc.Actual, 2024, 8, 2) |> aoc.expect(1231) |> aoc.run(part2)
}
